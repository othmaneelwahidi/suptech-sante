...
<div class="hero-imagefc">
            ...
            <div class="hero-textfc">
                <h6 class="display-4">Cycle Classes préparatoires intégrées: 2ème Année</h6>
...
<br>
    ...
    <ul style="margin-left: 10%; ">
        <li style="font-size: 2em; color: black;"><strong>Condition d'accès :</strong></li>
        <p style="font-size: 1.8em;">&ndash;Être titulaire d'un Baccalauréat Scientifique (svt/pc/sc.mathématiques A ou B,...)</p>
