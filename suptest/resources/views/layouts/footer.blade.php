      ...
      <div class="col-lg-4 col-md-4 footer-links">
            <h4> {{ __('messages.nf') }} :  </h4>
              <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('cp', ['slug' => App::getLocale()]) }}"> {{ __('messages.ccpi') }} </a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('ci', ['slug' => App::getLocale()]) }}"> {{ __('messages.ingenieur') }}</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('cl', ['slug' => App::getLocale()]) }}">{{ __('messages.licence') }}</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('cm', ['slug' => App::getLocale()]) }}"> {{ __('messages.cmm') }}</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('fc', ['slug' => App::getLocale()]) }}" > {{ __('messages.fc') }}</a></li>
...
@endif
                ...
                <p> <br><strong> {{ __('messages.email') }} :</strong> contact@suptech-sante.ma<br></p>
                <br>

                <div class="social-links mt-3">
                    <a href="https://www.facebook.com/suptechsante"  target="_blank" class="facebook"  traget="_blank" > <i class="bi bi-facebook"></i></a>
                    <a href="https://www.instagram.com/suptech.sante/"  target="_blank"  class="instagram"><i class="bi bi-instagram"></i></a>
                    <a href="https://www.linkedin.com/company/suptech-sante/"  target="_blank" class="linkedin"><i class="bi bi-linkedin"></i></i></a>
                </div>
