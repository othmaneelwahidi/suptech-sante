...
<section id="topbar" class="d-flex align-items-center" style="background-color: rgba(0, 123, 255, 0.2);">
    <div class="container d-flex justify-content-center justify-content-md-between">
        ...
        <div class="contact-info d-flex align-items-center">
            <i class="bi bi-envelope-fill"></i><a href="mailto:contact@suptech-sante.ma">contact@suptech-sante.ma</a>
            @if (Session::has('locale'))
        ...
        <div class="social-links d-none d-md-block">
            <a href="https://www.facebook.com/suptechsante" target="_blank" class="facebook" traget="_blank"> <i
                    class="bi bi-facebook"></i></a>
            <a href="https://www.instagram.com/suptech.sante/" target="_blank" class="instagram"><i
                    class="bi bi-instagram"></i></a>
            <a href="https://www.linkedin.com/company/suptech-sante/" target="_blank" class="linkedin"><i
...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
        ...
        @if (Session::has('locale'))
            @if (Session::get('locale') == 'fr')
                <div class="logo">
                    <a href="/fr" class="logoo"> <img src="{{ asset('logo.webp') }}" width="200" height="200"
                            alt="Logo suptech-sante" class="img-fluid"> </a>
                    <!-- Uncomment below if you prefer to use an image logo -->
                    <!-- <a href="/"><img src="logo_img.png" alt="" class="img-fluid"></a>-->
                </div>
            @else
                <div class="logo">
                    <a href="/ar" class="logoo"><img src="{{ asset('logo.webp') }}" alt="Logo suptech-sante"
                            class="img-fluid"> </a>
                    <!-- Uncomment below if you prefer to use an image logo -->
                    <!-- <a href="/"><img src="logo_img.png" alt="" class="img-fluid"></a>-->
                </div>
