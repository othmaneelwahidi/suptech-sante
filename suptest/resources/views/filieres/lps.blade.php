...
<section class="counts section-bg"  data-aos="fade-up" >
    <div class="container">
          ...
          <div class="count-box sector">
              <i class="bi bi-simple-smile" style="color: #20b38e;"></i>
              <h2>{{ __('messages.Bac') }} : </h2> <hr>
              <h3>- {{ __('messages.bs') }} .</h3> 
              <h3>- {{ __('messages.be') }} .</h3> 
            </div>
          </div>
          ...
          <div class="count-box sector">
              <i class="bi bi-simple-smile" style="color: #20b38e;"></i>
              <h2>{{ __('messages.ap') }} :</h2> <hr>
              <h3>- {{ __('messages.etd') }}  .</h3> 
              <h3>- {{ __('messages.etdeugds') }} .</h3> 
              <h3>- {{ __('messages.etdeuecg') }} .</h3>  
            </div>
          </div>
...
<div class="row mb-4"> </div>
  ...
  <script>  
        $(".changeLang").change(function(){
            if($(this).val() == 'fr'){
                window.location.href = "/fr/lps";
            }else if($(this).val() == 'ar'){
                window.location.href = "/ar/lps";
            }
        });
    </script>
</body>
