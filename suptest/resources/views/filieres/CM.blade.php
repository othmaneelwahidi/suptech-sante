...
<section class="counts section-bg">
      ...
      <div class="row mb-4"> </div>
          ...
          <div class="count-box sector">
              ...
              <a href="{{ route('masterd', ['slug' => App::getLocale()]) }}"><h4>- {{ __('messages.mdmar') }} . </h4></a>
              <a href="{{ route('mastermaint', ['slug' => App::getLocale()]) }}"><h4>- {{ __('messages.mmgb') }} . </h4></a>
              <a href="{{ route('mastere', ['slug' => App::getLocale()]) }}"><h4>- {{ __('messages.memt') }}.  </h4></a>
