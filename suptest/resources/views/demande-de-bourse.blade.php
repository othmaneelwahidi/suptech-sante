...
@section('content')
    ...
    @endif
    <form id="OrderInfo" action="{{ route('submit_bourse', ['slug' => App::getLocale()]) }}" method="post" role="form"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 form-group">
                    ...
                    <input type="text" name="Nom" class="form-control" id="Nom" placeholder="Nom complet"
                        required="">
                </div>
                ...
                <div class="col-lg-4 col-md-6 form-group">
                    ...
                    <input type="text" class="form-control" name="cin" id="cin" placeholder="Numéro de CIN"
                        required="">
                </div>
            </div>
            <div class="row">
            ...
            <input type="hidden" class="form-control" name="tsrc" id="tsrc" placeholder="tsrc" pattern="\d+"
                value="">
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 form-group">
                ...
                <input type="text" class="form-control" name="cin_massar" id="cin_massar" placeholder="Code massar (CNE)"
                    required="">
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input type="text" class="form-control" name="nom_pere_complet" id="nom_pere_complet"
                        placeholder="Nom complet père" required="">
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 form-group">
                    ...
                    <input type="text" class="form-control" name="ncm" id="ncm" placeholder="Nom Complet mère"
                        required="">
                </div>

                <div class="col-lg-6 col-md-6 form-group">
                    <label for="profession_mere">Etat:</label>
                    <select class="form-select" name="profession_mere" id="mySeleprofession_merect" aria-label="select"
                        required="">
                        <option disabled selected value="">Etat</option>
            ...
            <div class="row">
                <div class="col-lg-6 form-group">
                    ...
                    <input type="text" class="form-control" name="nct" id="nct"
                        placeholder="Nom Complet mère" required="">
                </div>
